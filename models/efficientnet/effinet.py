'''reference : https://github.com/zsef123/EfficientNets-PyTorch'''
...
# from efficientnet.layers import conv_bn_act
# from efficientnet.layers import SamePadConv2d
# from efficientnet.layers import Flatten
# from efficientnet.layers import SEModule
# from efficientnet.layers import DropConnect
...
if __name__ == "__main__":
    ...
    net = EfficientNet(1, 1, num_classes=345).cuda()
    output = net(inputs).shape
